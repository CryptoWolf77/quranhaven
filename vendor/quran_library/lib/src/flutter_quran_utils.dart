...
class QuranLibrary {
  ...
  /// Loads and validates a resource before reporting it ready. Unlike the
  /// legacy selection callback, failures are returned to the caller.
  Future<void> prepareTafsir(int index, {int? pageNumber}) =>
      TafsirCtrl.instance.prepareResource(index, pageNumber: pageNumber);
